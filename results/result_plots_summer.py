...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 24 11:43:14 2023
...
try:
    ...
    shimg_moyal4 = list(file4.lbhs_pos.values+150)
    shimg_mean4 = list(file4.lbhs_pos_1.values+150)
    shimg_moyal5 = list(file5.lbhs_pos.values+150)
    shimg_mean5 = list(file5.lbhs_pos_1.values+150)
except:pass
...
bi_moyal4 = detect_boundaries_s_M(imgs_moyal4, HiLDA)
bi_mean4 = detect_boundaries_s_m(imgs_mean4, HiLDA)
bi_moyal5 = detect_boundaries_s_M(imgs_moyal5, HiLDA)
bi_mean5 = detect_boundaries_s_m(imgs_mean5, HiLDA)
